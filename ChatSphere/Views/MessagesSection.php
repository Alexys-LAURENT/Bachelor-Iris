...
<div class="lg:w-[57%] w-full overflow-hidden dark:bg-dark transition-all duration-500">
    <nav class="w-full flex h-[50px] border-b-2 dark:text-white transition-all duration-500">
        ...
        <div onclick="toggleMembers()" class="min-w-[50px] flex block lg:hidden border-s-2 duration-500">
            <button class="w-full flex  justify-center items-center">
